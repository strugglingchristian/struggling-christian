    ...
    <div id="articles">
      ...
      <div className="body-content">
        <p>
          ...
          . If only the answer to all the questions about life is this simple
          and can be calculated by a computer, it would certainly solve a lot of
          our problems.
        </p>
        <p align="center">
          <img
        ...
        <p>
          ...
          when it didn&apos;t happen, changed the date to October 21, 2011. Many
          of his believers donated money, amounting to millions of dollars.
          ...
          later in 2013. Meanwhile, Family Radio administrators have repented of
          their date setting and Family Radio is still active to this day, just
          without the date setting. This is the sad reality when people were
          deluded into believing erroneous date setting for the Lord&apos;s
          return. What happened to Harold Camping’s believers are eerily similar
          (except maybe for the cases of killings) to what happened with William
          Miller and the Millerite movement. And like the supercomputer Deep
          Thought who computed the answer to the{" "}
          <strong>
